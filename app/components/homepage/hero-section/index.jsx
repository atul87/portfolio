      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="my-12 flex items-center gap-5">
            ...
            <Link
              href={personalData.code360}
              target='_blank'
              className="transition-all text-pink-500 hover:scale-125 duration-300"
              aria-label="Naukri Code360 Profile"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <Link className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-pink-500 to-violet-600 px-3 md:px-8 py-3 md:py-4 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold" role="button" target="_blank" href={personalData.resume || personalData.github}
            >
              <span>{personalData.resume ? "Get Resume" : "View GitHub"}</span>
              {personalData.resume ? <MdDownload size={16} /> : <BsGithub size={16} />}
            </Link>
          </div>
